...
```
Результат работы программы - информация по статистическим характеристикам каждого свойста объектов. Набор статистических характеристик по которым приводится отчет подробно описан в документации сформированной на предыдущем шаге.
### Визуализация данных
