...
```
<br>
8. После успешной отработки программы-классификатора в папке _datasets_/ будет сформирован файл _houses.csv_ с результатами предсказаний по каждому объекту из файла с тестовыми данными и на экран выведена информация об окончании работы.  <br>
В случае ошибки, будет выдано соответствующее сообщение. <br><br>
